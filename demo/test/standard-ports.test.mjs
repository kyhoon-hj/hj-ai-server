...
test('로컬과 운영의 세 애플리케이션 포트를 고정한다', () => {
...
test('표준과 다른 데모 포트를 거절한다', () => {
  assert.throws(() => requireStandardPort('validationDemo', 3200), /11001로 고정/);
  assert.throws(() => requireStandardPort('serviceDemo', 12002), /11002로 고정/);
});
