...
| 구분 | 결과 | 증거 |
|---|---:|---|
| AI Server 단위 테스트 | 34/34 PASS | Jest 12 suites |
| AI Server HTTP e2e | 6/6 PASS | AppInfo 관리자 인증 포함 |
...
- AppInfo는 단일 `platform-admin` credential로 보호됐지만 세분화된 RBAC, 키 만료·감사·무중단 회전은 남아 있습니다.
