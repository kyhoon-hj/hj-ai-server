...
4. 수동 시험만 할 경우 데모용 AppInfo와 appkey를 준비합니다. 자동 검증 환경 구성 기능은 app과 키를 직접 준비합니다.
